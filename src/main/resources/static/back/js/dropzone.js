...
function(e, t) {
            ...
            "use strict"; (function(e) {
                ...
                o = function(e) {
                    function o(e, t) {
                        ...
                        if (r.options = o.extend({},
                        r.defaultOptions, u, null != t ? t: {}), r.options.forceFallback || !o.isBrowserSupported()) return l = r.options.fallback.call(r),
                        i(r, l);
                        ...
                        (a = r.getExistingFallback()) && a.parentNode && a.parentNode.removeChild(a),
                        !1 !== r.options.previewsContainer && (r.options.previewsContainer ? r.previewsContainer = o.getElement(r.options.previewsContainer, "previewsContainer") : r.previewsContainer = r.element),
                        r.options.clickable && (!0 === r.options.clickable ? r.clickableElements = [r.element] : r.clickableElements = o.getElements(r.options.clickable, "clickable")),
                        r.init(),
                        r
                    }
                    return function(e, t) {
                        ...
                        value: function() {
                            ...
                            this.prototype.defaultOptions = {
                                ...
                                addedfile: function(e) {
                                    ...
                                    if (this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer) {
                                        ...
                                        for (var l = function(i) {
                                            ...
                                            i.stopPropagation(),
                                            e.status === o.UPLOADING ? o.confirm(t.options.dictCancelUploadConfirmation,
                                            function() {
                                                return t.removeFile(e)
                                            }) : t.options.dictRemoveFileConfirmation ? o.confirm(t.options.dictRemoveFileConfirmation,
                                            function() {
                                                return t.removeFile(e)
                                            }) : t.removeFile(e)
                                        },
                                ...
                                uploadprogress: function(e, t, i) {
                                    if (e.previewElement) for (var n = e.previewElement.querySelectorAll("[data-dz-uploadprogress]"), r = 0, n = n; ! (r >= n.length);) {
                                        var o = n[r++];
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            ...
                            i = Array(t > 1 ? t - 1 : 0), n = 1; n < t; n++) i[n - 1] = arguments[n];
                            for (var r = i,
                            o = 0,
                            r = r; ! (o >= r.length);) {
                                var a = r[o++];
                    ...
                    },
                    {
                        ...
                        value: function() {
                            ...
                            function t() {
                                ...
                                e.hiddenFileInput.addEventListener("change",
                                function() {
                                    var i = e.hiddenFileInput.files;
                                    if (i.length) for (var n = 0,
                                    r = r = i; ! (n >= r.length);) {
                                        var o = r[n++];
                                        e.addFile(o)
                                    }
                    ...
                    },
                    {
                        ...
                        value: function() {
                            ...
                            return "FORM" !== this.element.tagName ? (t = o.createElement('<form action="' + this.options.url + '" enctype="multipart/form-data" method="' + this.options.method + '"></form>')).appendChild(n) : (this.element.setAttribute("enctype", "multipart/form-data"), this.element.setAttribute("method", this.options.method)),
                            null != t ? t: n
                        }
                    },
                    {
                                    ...
                                    if (n.length > 0) {
                                        ...
                                        r = r; ! (o >= r.length);) {
                                            ...
                                            a.isFile ? a.file(function(e) {
                                                if (!i.options.ignoreHiddenFiles || "." !== e.name.substring(0, 1)) return e.fullPath = t + "/" + e.name,
                                                i.addFile(e)
                    ...
                    },
                    {
                        ...
                        value: function() {
                            ...
                            if (!this._processingThumbnail && 0 !== this._thumbnailQueue.length) {
                                ...
                                return this.createThumbnail(t, this.options.thumbnailWidth, this.options.thumbnailHeight, this.options.thumbnailMethod, !0,
                                function(i) {
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            ...
                            for (var t = this.files.slice(), i = 0, t = t; ! (i >= t.length);) {
                                var n = t[i++]; (n.status !== o.UPLOADING || e) && this.removeFile(n)
                            }
                            return null
                        }
                    },
                        ...
                        value: function(e, t, i, n, r, o, a) {
                            ...
                            u.onload = function() {
                                ...
                                a(function(r) {
                                    ...
                                    case 2:
                                        c.translate(d.width, 0),
                                        c.scale( - 1, 1);
                                        break;
                                    case 3:
                                        c.translate(d.width, d.height),
                                        c.rotate(Math.PI);
                                        break;
                                    case 4:
                                        c.translate(0, d.height),
                                        c.scale(1, -1);
                                        break;
                                    case 5:
                                        c.rotate(.5 * Math.PI),
                            ...
                            function(i) {
                                if (e[0].upload.chunked) {
                                    ...
                                    if (n.upload.finishedChunkUpload = function(i) {
                                        ...
                                        r && t.options.chunksUploaded(n,
                                        function() {
                                            t._finished(e, "", null)
                                        })
                                    },
                                    t.options.parallelChunkUploads) for (var s = 0; s < n.upload.totalChunkCount; s++) a();
                                    else a()
                                } else {
                    ...
                    },
                    {
                        ...
                        value: function(e, t) {
                            ...
                            this.options.uploadMultiple && this.emit("sendingmultiple", e, n, f),
                    ...
                    },
                    {
                        ...
                        value: function(e, t) {
                            for (var i = this,
                            n = [], r = 0, o = function(o) {
                                i.options.transformFile.call(i, e[o],
                                function(i) {
                                    n[o] = i,
                                    ++r === e.length && t(n)
                                })
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            if ("FORM" === this.element.tagName) for (var t = this.element.querySelectorAll("input, textarea, select, button"), i = 0, t = t; ! (i >= t.length);) {
                                var n = t[i++],
                                r = n.getAttribute("name"),
                                o = n.getAttribute("type");
                                if (o && (o = o.toLowerCase()), void 0 !== r && null !== r) if ("SELECT" === n.tagName && n.hasAttribute("multiple")) for (var a = n.options,
                                s = 0,
                                a = a; ! (s >= a.length);) {
                                    var l = a[s++];
                    ...
                    },
                    {
                        ...
                        value: function(e, t, i) {
                            ...
                            if (void 0 !== i) {
                                ...
                                f = f; ! (v >= f.length);) {
                                    var m = f[v++];
                                    100 === m.upload.progress && m.upload.bytesSent === m.upload.total || (h = !1),
                                    m.upload.progress = n,
                ...
                o.discover = function() {
                    ...
                    return function() {
                        for (var t = [], i = e, n = 0, i = i; ! (n >= i.length);) {
                            var r = i[n++]; ! 1 !== o.optionsForElement(r) ? t.push(new o(r)) : t.push(void 0)
                        }
                        return t
                    } ()
                },
                ...
                o.isBrowserSupported = function() {
                    var e = !0;
                    if (window.File && window.FileReader && window.FileList && window.Blob && window.FormData && document.querySelector) if ("classList" in document.createElement("a")) for (var t = o.blacklistedBrowsers,
                    i = 0,
                    t = t; ! (i >= t.length);) {
                        var n = t[i++];
                ...
                o.getElements = function(e, t) {
                    ...
                    if (e instanceof Array) {
                        ...
                        n = [];
                        for (var a = document.querySelectorAll(e), s = 0, a = a; ! (s >= a.length);) i = a[s++],
                        n.push(i)
                ...
                o.isValidFile = function(e, t) {
                    ...
                    t = t.split(",");
                    for (var i = e.type,
                    n = i.replace(/\/.*$/, ""), r = t, o = 0, r = r; ! (o >= r.length);) {
                        var a = r[o++];
                ...
                void 0 !== e && null !== e ? e.exports = o: window.Dropzone = o,
                o.ADDED = "added",
                o.QUEUED = "queued",
                o.ACCEPTED = o.QUEUED,
                ...
                u = function() {
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            ...
                            s = void 0,
                            l = "",
                            u = 0; i = e[u++], n = e[u++], r = e[u++], o = i >> 2, a = (3 & i) << 4 | n >> 4, s = (15 & n) << 2 | r >> 6, l = 63 & r, isNaN(n) ? s = l = 64 : isNaN(r) && (l = 64), t = t + this.KEY_STR.charAt(o) + this.KEY_STR.charAt(a) + this.KEY_STR.charAt(s) + this.KEY_STR.charAt(l), i = n = r = "", o = a = s = l = "", u < e.length;);
                            return t
                        }
                    },
                    {
                ...
                function(e, t) {
                    ...
                    u = function n(o) {
                        if ("readystatechange" !== o.type || "complete" === r.readyState) return ("load" === o.type ? e: r)[s](l + o.type, n, !1),
    ...
    if ("object" == typeof i) {
        ...
        for (var r in i) n[0] && (n[0][r] = i[r]),
        n[1] && "__esModule" !== r && (n[1][r] = i[r]),
        n[2] && (n[2][r] = i[r])
    }
} (this);