 ...
 */
                ...
                function(s, n, r) {
                    "use strict";
                    var o = s.navigator.msPointerEnabled;
                    function a(e) {
                        if (this.support = !("undefined" == typeof File || "undefined" == typeof Blob || "undefined" == typeof FileList || !Blob.prototype.slice && !Blob.prototype.webkitSlice && !Blob.prototype.mozSlice), this.support) {
                            this.supportDirectory = /Chrome/.test(s.navigator.userAgent) || /Firefox/.test(s.navigator.userAgent) || /Edge/.test(s.navigator.userAgent),
                            this.files = [],
                            this.defaults = {
                                chunkSize: 1048576,
                                forceChunkSize: !1,
                    ...
                    function h(e, t, i) {
                        ...
                        this.uniqueIdentifier = i === r ? e.generateUniqueIdentifier(t) : i,
                        this.chunks = [],
                        this.paused = !1,
                        this.error = !1,
                        this.averageSpeed = 0,
                    ...
                    function u(e, t, i) {
                        ...
                        this.xhr = null;
                        var s = this;
                        this.event = function(e, t) { (t = Array.prototype.slice.call(arguments)).unshift(s),
                            s.fileObj.chunkEvent.apply(s.fileObj, t)
                        },
                        this.progressHandler = function(e) {
                            e.lengthComputable && (s.loaded = e.loaded, s.total = e.total),
                            s.event("progress", e)
                        },
                        this.testHandler = function(e) {
                            var t = s.status(!0);
                            "error" === t ? (s.event(t, s.message()), s.flowObj.uploadNextChunk()) : "success" === t ? (s.tested = !0, s.event(t, s.message()), s.flowObj.uploadNextChunk()) : s.fileObj.paused || (s.tested = !0, s.send())
                        },
                        this.doneHandler = function(e) {
                            var t = s.status();
                            if ("success" === t || "error" === t) delete this.data,
                            s.event(t, s.message()),
                            s.flowObj.uploadNextChunk();
                            else {
                                s.event("retry", s.message()),
                                s.pendingRetry = !0,
                                s.abort(),
                                s.retries++;
                                var i = s.flowObj.opts.chunkRetryInterval;
                    ...
                    function f(e, t) {
                        return "function" == typeof e && (t = Array.prototype.slice.call(arguments), e = e.apply(null, t.slice(1))),
                        e
                    }
                    function p(e, t) {
                    ...
                    function d(e, t, i) {
                        var s;
                        if (e) if (void 0 !== e.length) {
                            for (s = 0; s < e.length; s++) if (!1 === t.call(i, e[s], s)) return
                        } else for (s in e) if (e.hasOwnProperty(s) && !1 === t.call(i, e[s], s)) return
                    }
                    a.prototype = {
                        on: function(e, t) {
                            e = e.toLowerCase(),
                        ...
                        off: function(e, t) {
                            var i, s, n;
                            e !== r ? (e = e.toLowerCase(), t !== r ? this.events.hasOwnProperty(e) && (i = this.events[e], s = t, (n = i.indexOf(s)) > -1 && i.splice(n, 1)) : delete this.events[e]) : this.events = {}
                        },
                        fire: function(e, t) {
                            t = Array.prototype.slice.call(arguments),
                            e = e.toLowerCase();
                            var i = !1;
                            return this.events.hasOwnProperty(e) && d(this.events[e],
                            function(e) {
                                i = !1 === e.apply(this, t.slice(1)) || i
                            },
                            this),
                            "catchall" != e && (t.unshift("catchAll"), i = !1 === this.fire.apply(this, t) || i),
                            !i
                        },
                        webkitReadDataTransfer: function(e) {
                            ...
                            function(e) {
                                ...
                                t ? t.isFile ? n(e.getAsFile(), t.fullPath) : function e(t) {
                                    t.readEntries(function(s) {
                                        s.length ? (i += s.length, d(s,
                                        function(t) {
                                            if (t.isFile) {
                                                var i = t.fullPath;
                                                t.file(function(e) {
                                                ...
                                                r)
                                            } else t.isDirectory && e(t.createReader())
                                        }), e(t)) : o()
                                    },
                                    r)
                                } (t.createReader()) : o()
                        ...
                        uploadNextChunk: function(e) {
                            var t = !1;
                            if (this.opts.prioritizeFirstAndLastChunk && (d(this.files,
                            function(e) {
                            ...
                            if (d(this.files,
                            function(e) {
                                if (e.paused || d(e.chunks,
                                function(e) {
                                    if ("pending" === e.status()) return e.send(),
                                    t = !0,
                                    !1
                                }), t) return ! 1
                            }), t) return ! 0;
                        ...
                        assignBrowse: function(e, t, i, s) {
                            e instanceof Element && (e = [e]),
                            d(e,
                            function(e) {
                                var r;
                                "INPUT" === e.tagName && "file" === e.type ? r = e: ((r = n.createElement("input")).setAttribute("type", "file"), c(r.style, {
                                    visibility: "hidden",
                                    position: "absolute",
                                    width: "1px",
                                    height: "1px"
                                }), e.appendChild(r), e.addEventListener("click",
                                function() {
                                    r.click()
                                },
                                !1)),
                                this.opts.singleFile || i || r.setAttribute("multiple", "multiple"),
                                t && r.setAttribute("webkitdirectory", "webkitdirectory"),
                                d(s,
                                function(e, t) {
                                    r.setAttribute(t, e)
                                });
                                ...
                                function(e) {
                                    e.target.value && (o.addFiles(e.target.files, e), e.target.value = "")
                                },
                                !1)
                            },
                            this)
                        ...
                        _shouldUploadNext: function() {
                            ...
                            function(s) {
                                d(s.chunks,
                                function(s) {
                                    if ("uploading" === s.status() && ++e >= i) return t = !1,
                                    !1
                                })
                            }),
                            t && e
                        ...
                        upload: function() {
                            ...
                            if (!1 !== e) {
                                ...
                                for (var t = !1,
                                i = 1; i <= this.opts.simultaneousUploads - e; i++) t = this.uploadNextChunk(!0) || t;
                                t || p(function() {
                                    this.fire("complete")
                                },
                                this)
                        ...
                        addFiles: function(e, t) {
                            ...
                            d(e,
                            function(e) {
                                if ((!o || o && e.size > 0) && (e.size % 4096 != 0 || "." !== e.name && "." !== e.fileName)) {
                                    var s = this.generateUniqueIdentifier(e);
                                    if (this.opts.allowDuplicateUploads || !this.getFromUniqueIdentifier(s)) {
                                        var n = new h(this, e, s);
                                        this.fire("fileAdded", n, t) && i.push(n)
                                    }
                                }
                            },
                            this),
                            this.fire("filesAdded", i, t) && (d(i,
                            function(e) {
                                this.opts.singleFile && this.files.length > 0 && this.removeFile(this.files[0]),
                                this.files.push(e)
                            },
                            this), this.fire("filesSubmitted", i, t))
                        },
                        ...
                        timeRemaining: function() {
                            ...
                            return d(this.files,
                            function(i) {
                                i.paused || i.error || (e += i.size - i.sizeUploaded(), t += i.averageSpeed)
                            }),
                    ...
                    h.prototype = {
                        ...
                        chunkEvent: function(e, t, i) {
                            ...
                            case "success":
                                ...
                                this.flowObj.fire("progress"),
                                this._lastProgressCallback = Date.now(),
                                this.isComplete() && (this.currentSpeed = 0, this.averageSpeed = 0, this.flowObj.fire("fileSuccess", this, i, e));
                                break;
                            case "retry":
                        ...
                        bootstrap: function() {
                            ...
                            this.error = !1,
                            this._prevProgress = 0;
                            for (var e = this.flowObj.opts.forceChunkSize ? Math.ceil: Math.floor, t = Math.max(e(this.size / this.flowObj.opts.chunkSize), 1), i = 0; i < t; i++) this.chunks.push(new u(this.flowObj, this, i))
                        },
                        progress: function() {
                            if (this.error) return 1;
                            if (1 === this.chunks.length) return this._prevProgress = Math.max(this._prevProgress, this.chunks[0].progress()),
                            this._prevProgress;
                            var e = 0;
                            d(this.chunks,
                            function(t) {
                        ...
                        isUploading: function() {
                            var e = !1;
                            return d(this.chunks,
                            function(t) {
                                if ("uploading" === t.status()) return e = !0,
                                !1
                            }),
                            e
                        },
                        isComplete: function() {
                            ...
                            function(t) {
                                var i = t.status();
                                if ("pending" === i || "uploading" === i || "reading" === i || 1 === t.preprocessState || 1 === t.readState) return e = !0,
                                !1
                            }),
                            !e
                        },
                    ...
                    u.prototype = {
                        ...
                        send: function() {
                            ...
                            if (!this.flowObj.opts.testChunks || this.tested) {
                                ...
                                var i = f(this.flowObj.opts.uploadMethod, this.fileObj, this),
                                s = this.prepareXhrRequest(i, !1, this.flowObj.opts.method, this.bytes);
                                this.xhr.send(s)
                            } else this.test()
                        },
                        abort: function() {
                        ...
                        prepareXhrRequest: function(e, t, i, s) {
                            var n = f(this.flowObj.opts.query, this.fileObj, this, t);
                            n = c(n, this.getParams());
                            var r = f(this.flowObj.opts.target, this.fileObj, this, t),
                            o = null;
                            if ("GET" === e || "octet" === i) {
                                var a = [];
                                d(n,
                                function(e, t) {
                                    a.push([encodeURIComponent(t), encodeURIComponent(e)].join("="))
                                }),
                                r = this.getTarget(r, a),
                                o = s || null
                            } else o = new FormData,
                            d(n,
                            function(e, t) {
                            ...
                            void 0 !== s && o.append(this.flowObj.opts.fileParameterName, s, this.fileObj.file.name);
                            return this.xhr.open(e, r, !0),
                            this.xhr.withCredentials = this.flowObj.opts.withCredentials,
                            d(f(this.flowObj.opts.headers, this.fileObj, this, t),
                            function(e, t) {
                    ...
                    a.FlowChunk = u,
                    a.version = "<%= version %>",
                    "object" == typeof e && e && "object" == typeof e.exports ? e.exports = a: (s.Flow = a, (i = function() {
                        return a
    ...
    if ("object" == typeof i) {
        var s = ["object" == typeof module && "object" == typeof module.exports ? module.exports: null, "undefined" != typeof window ? window: null, e && e !== window ? e: null];
        for (var n in i) s[0] && (s[0][n] = i[n]),
        s[1] && "__esModule" !== n && (s[1][n] = i[n]),
        s[2] && (s[2][n] = i[n])
    }
} (this);